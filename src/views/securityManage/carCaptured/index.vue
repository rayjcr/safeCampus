<template>
    <div class="page-container car-captured">
            ...
            <div class="m_GenTableBox u-flex u-flex_row">
                <div class="m_GenCenter u-flex_row">
                    ...
                    >
                        ...
                        >
                            <div class="infoItem">
                                车牌号： <span>{{ item.num }}</span>
                            </div>
                            <div class="infoItem">
                                经过时间： <span>{{ item.passtime }}</span>
                            </div>
                            <div class="infoItem">
                                车辆类型：<span>{{ item.typeName }}</span>
                            </div>
                            <div class="infoItem">
...
import ConfirmDialog from "./carConfirm";
...
export default {
    ...
    methods: {
        ...
        getList () {
            ...
            api.getCarSnapList(filtersObj).then(res => {
                ...
                this.tableData.map(item => {
                    ...
                    if (item.type !== '0') {
                        item.imgBtnName = '修改车辆';
                    } else if (item.type == '0') {
                        item.imgBtnName = '保存车辆';
                    }
                    return item
                })
            })
